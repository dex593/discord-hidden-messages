// ==UserScript==
// @name         Discord Invisible Messages (Zero-Width)
// @namespace    https://example.com/
// @version      0.1.23
// @description  Hide Discord messages using zero-width encoding; decode for users with this script.
...
(function () {
  ...
  function getSharedKey() {
    if (!SHARED_KEY || SHARED_KEY === "CHANGE_ME") return "";
    return SHARED_KEY;
  }
  ...
  function wrapMessageListener(listener) {
    ...
    const wrapped = function (event) {
      if (!event || typeof event.data !== "string") return listener.call(this, event);
