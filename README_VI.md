...
Repo này có hai cách sử dụng trên Discord web: một tiện ích trình duyệt và một Tampermonkey userscript. Chỉ dùng một trong hai (extension hoặc userscript), không dùng cùng lúc.
